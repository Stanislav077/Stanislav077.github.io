												...
												<div class="mfilter-option mfilter-tb-as-tr">
													...
													<label class="mfilter-tb-as-td" for="mfilter-opts-attribs-<?php echo (int) $_idx; ?>-<?php echo $base_id; ?>-<?php echo $option['key']; ?>">
														<?php if( in_array( $_tmp_type, array( 'image_list_radio', 'image_list_checkbox' ) ) ) { ?>
															...
															?>
															<img src="<?php echo $option['image']; ?>" width="<?php echo $w; ?>" height="<?php echo $h; ?>" /> <?php echo $option['name']; ?>
														<?php } else { ?>
															<?php echo $option['name']; ?>
														<?php } ?>
													</label>
													<div class="mfilter-tb-as-td mfilter-col-count"><span class="group_count">(</span><span class="mfilter-counter">0</span><span class="group_count">)</span></div>
												</div>
