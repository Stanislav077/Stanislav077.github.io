<script type="text/javascript"><!--
	...
	poip_product_custom.prototype.custom_elevateZoomSwap = function(small_image, large_image) {
	...
	poip_product_custom.prototype.if_updateZoomImage = function(img_click) {
		...
		if ( poip_img ) {
			this_object.custom_elevateZoomSwap(poip_img['popup'], poip_img['popup']);
			this_object.custom_refreshPopup();
		}
