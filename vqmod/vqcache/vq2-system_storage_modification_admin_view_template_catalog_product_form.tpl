<?php echo $header; ?>
      ...
      ?>
      <!-- >> Product Option Image PRO module --><?php echo $column_left; ?>
<div id="content">
    ...
    <div class="panel panel-default">
                        ...
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          <thead>
                            <tr>
                              ...
                              <td class="text-right"><?php echo $entry_weight; ?></td><!-- Product Option Image PRO module << // new --><?php if ( !empty($poip_installed) && !$poip_global_settings['options_images_edit'] ) { ?><td class="text-left" style="width:240px;"><?php echo $entry_image; ?></td><?php } ?><!-- >> Product Option Image PRO module -->
                              <td></td>
                            </tr>
                          </thead>
                          <tbody>
      ...
      <!-- >> Product Option Image PRO module -->
                          ...
                          <tfoot>
                            <tr>
                              <td colspan="6"></td>
                              <!-- Product Option Image PRO module << // new --><?php if ( !empty($poip_installed) && !$poip_global_settings['options_images_edit'] ) { ?><td></td><?php } ?><!-- >> Product Option Image PRO module --><td class="text-left"><button type="button" onclick="addOptionValue('<?php echo $option_row; ?>');" data-toggle="tooltip" title="<?php echo $button_option_value_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                            </tr>
                          </tfoot>
                        </table>
                      </div>
	...
	'select': function(item) {
      ...
      ?><label class="col-sm-2 control-label" for="input-required' + option_row + '"><?php echo $entry_required; ?></label>';
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			html += '        <td class="text-right"><?php echo $entry_weight; ?></td><!-- Product Option Image PRO module << // new --><?php if ( !empty($poip_installed) && !$poip_global_settings['options_images_edit'] ) { ?><td class="text-left" style="width:240px;"><?php echo $entry_image; ?></td><?php } ?><!-- >> Product Option Image PRO module -->';
			html += '        <td></td>';
			html += '      </tr>';
			html += '  	 </thead>';
			html += '  	 <tbody>';
			...
			html += '        <!-- Product Option Image PRO module << // new --><?php if ( !empty($poip_installed) && !$poip_global_settings['options_images_edit'] ) { ?><td></td><?php } ?><!-- >> Product Option Image PRO module --><td class="text-left"><button type="button" onclick="addOptionValue(' + option_row + ');" data-toggle="tooltip" title="<?php echo $button_option_value_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>';
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
			html += '</div>';
