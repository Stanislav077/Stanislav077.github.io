          ...
          <div class="active_latest main-sale__slider--item-per opt_new_<?php echo $product['product_id']; ?>">
            <div class="main-sale__slider--item">
              ...
              <div class="main-sale__slider--item--img">
                <img src="<?php echo $product['thumb']; ?>" <?php /* Product Option Image PRO module << */ if (!isset($current_class)) $current_class = time(); ?> data-poip_id="image_<?php echo "".$current_class."_".$product['product_id']; ?>" <?php   /*  >> Product Option Image PRO module */ ?>alt="<?php echo $product['name']; ?>">
              </div>
