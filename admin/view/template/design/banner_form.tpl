...
<div id="content">
 ...
 <td class="text-left">
   ...
   <textarea class="form-control" placeholder="Description" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][description]">  <?php echo $banner_image['description']; ?>   </textarea>
                    <?php } ?>
...
var baner_id = <?php echo $banner_id; ?>;
...
function addImage(language_id) {
	...
	if(baner_id == 7){
  html += '  <td class="text-left"><textarea class="form-control" placeholder="Description" name="banner_image[' + language_id + '][' + image_row + '][description]"> </textarea></td>';
