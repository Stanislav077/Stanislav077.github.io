            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right hide"><?php echo $information['sort_order']; ?></td>
                  <td class="text-right hide"><?php echo $information['link_more']; ?></td>
                  <td class="text-right "><?php echo $information['status']; ?></td>
