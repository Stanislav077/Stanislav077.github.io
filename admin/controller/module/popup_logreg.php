	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if ($this->request->post['apply']) {
				$url = $this->url->link('module/popup_logreg', 'token=' . $this->session->data['token'], 'SSL');
			} else {
 		...
 		if (isset($this->session->data['success'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('module/popup_logreg', 'token=' . $this->session->data['token'], 'SSL'),
   		);
		
		$data['action'] = $this->url->link('module/popup_logreg', 'token=' . $this->session->data['token'], 'SSL');
		...
		$config_vars = array(
			...
			'popup_logreg_login_success','popup_logreg_register_success',
		);
		...
		$this->response->setOutput($this->load->view('module/popup_logreg.tpl', $data));
	}
	
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/popup_logreg')) {
