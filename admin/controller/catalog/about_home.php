<?php
class ControllerCatalogAbouthome extends Controller {
	private $error = array();
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_abouthome->editInformation($this->request->get['id'], $this->request->post);
			...
			$this->response->redirect($this->url->link('catalog/about_home', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$results = $this->model_catalog_abouthome->getInformations($filter_data);
		...
		$this->response->setOutput($this->load->view('catalog/about_home_list', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['id'])) {
			$data['action'] = $this->url->link('catalog/about_home/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/about_home/edit', 'token=' . $this->session->data['token'] . '&id=' . $this->request->get['id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/about_home', 'token=' . $this->session->data['token'] . $url, true);

		if (isset($this->request->get['id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$information_info = $this->model_catalog_abouthome->getInformation($this->request->get['id']);
		}
		...
		$this->response->setOutput($this->load->view('catalog/about_home_form', $data));
	}
