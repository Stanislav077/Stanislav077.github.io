...
// Heading
$_['module_name']         = 'Изображения опций PRO [<a href="http://feofan.net" target="_blank">feofan.net</a>]';
...
<span class="help-block">Для работы модуля требуется <a href="http://github.com/vqmod/vqmod" target="_blank">vQmod</a> версии 2.6.1 или выше (<a href="http://liveopencart.ru/chto-takoe-vqmod/" target="_blank">что такое vQmod?</a>).</span>';
...
$_['module_info'] = '"'.$_['module_name'].'" Версия %s | Разработка: <a href="http://19th19th.ru" target="_blank">19th19th.ru</a> | Поддержка: opencart@19th19th.ru | ';
